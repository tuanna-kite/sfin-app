  ...
  function onConfirmPayment() {
    dispatch(
      setPopup({
        ...
        title: "Thông báo",
        desc: "Yêu cầu thanh toán đang được xét duyệt",
      })
    );
  }
  return (
    <>
      ...
      <Column flex="1" safeAreaBottom bg="primary.500">
          ...
          <Column px={5} mb={5} flex={1}>
            <Box>
              ...
              <Text color="#6B7280" fontSize={12} textAlign="center" mb={3}>
                Sử dụng ứng dụng Momo bật tính năng chuyển tiền qua QR, sau đó quét mã QR bên dưới
              </Text>
              <Column alignItems="center">
                <LinearGradient colors={["#F4762D", "#FCB03F"]} style={styles.qrBox}>
                  <Center my="4">
                    ...
                    <Text color="white">0345622467</Text>
                  </Center>
                  <Center bg="white" mx="12" p="6" rounded="lg">
                    <Image source={require("../../assets/qr-code.png")} alt="qr" size="md" />
                  </Center>
              ...
              <PrimaryInput placeholder="Nhập mã giao dịch" onChangeText={setPaymentCode} />
              <Center mt={3}>
