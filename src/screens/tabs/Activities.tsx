...
import { Column, Text, FlatList, Divider, Row, Image, IStackProps } from "native-base";
  ...
  return (
    <Column my={3} bg="#F3F4F6" shadow={2} rounded="3xl" {..._stack}>
      <Row justifyContent="space-between" p={5}>
        ...
        <Text color={!paid ? "#DC2626" : "#16A34A"} fontWeight={500} textAlign="center">
      ...
      <Row justifyContent="space-between" p={5}>
        ...
        <Row>
          <Text color="#6B7280" fontSize={10} fontWeight={500} textAlign="center">
            <Text color="#6B7280" fontSize={10} fontWeight={500} textAlign="center">
              Vay
            </Text>
            {startDate}
...
const Activities = () => {
  const renderPackageTag: ListRenderItem<any> = ({ item }) => {
